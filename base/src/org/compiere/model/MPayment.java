...
*/
	...
	public MBankStatement getBankStatementAssociated(){
		
		String whereClauseFinal = "C_Payment_ID=? ";
		
		MBankStatementLine line = new Query(getCtx(), I_C_BankStatementLine.Table_Name, whereClauseFinal, get_TrxName())
