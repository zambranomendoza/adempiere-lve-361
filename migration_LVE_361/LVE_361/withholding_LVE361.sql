...
INSERT INTO adempiere.lco_withholdingtype(ad_client_id, ad_org_id, created, createdby, updatedby, isactive, issotrx, lco_withholdingtype_id, description, updated, name, LVE_isiva, LVE_isislr)
  VALUES(@ID_CLIENT@, 0,CURRENT_TIMESTAMP, 100, 100, 'Y', 'Y', 5000000, 'Retencion del 75 % del Iva en Ventas', CURRENT_TIMESTAMP, 'Retencion 75% IVA en Ventas', 'Y', 'N')
;
INSERT INTO adempiere.lco_withholdingtype(ad_client_id, ad_org_id, created, createdby, updatedby, isactive, issotrx, lco_withholdingtype_id, description, updated, name, LVE_isiva, LVE_isislr)
  VALUES(@ID_CLIENT@, 0, CURRENT_TIMESTAMP, 100, 100, 'Y', 'N', 5000003, 'Retenciones de IVA 75% en Compras', CURRENT_TIMESTAMP, 'Ret. IVA 75% en Compras', 'Y', 'N')
;
INSERT INTO adempiere.lco_withholdingtype(ad_client_id, ad_org_id, created, createdby, updatedby, isactive, issotrx, lco_withholdingtype_id, description, updated, name, LVE_isiva, LVE_isislr)
...
;
INSERT INTO adempiere.c_tax(c_tax_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, name, updatedby, description, taxindicator, isdocumentlevel, validfrom, issummary, requirestaxcertificate, rate, parent_tax_id, c_country_id, c_region_id, to_country_id, to_region_id, c_taxcategory_id, isdefault, istaxexempt, sopotype, issalestax, ad_rule_id)
  VALUES(5000103, @ID_CLIENT@, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PNR', 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PNR)', NULL, 'Y', '2000-01-01 00:00:00.0', 'N', 'N', 3, NULL, NULL, NULL, NULL, NULL, 5000011, 'N', 'N', 'B', 'N', NULL)
;
INSERT INTO C_Tax_Trl (AD_Language,C_Tax_ID, Description,Name,TaxIndicator, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,
UpdatedBy) SELECT l.AD_Language,t.C_Tax_ID, t.Description,t.Name,t.TaxIndicator, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,
t.Updated,t.UpdatedBy FROM AD_Language l, C_Tax t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND 
...
;
INSERT INTO adempiere.c_tax(c_tax_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, name, updatedby, description, taxindicator, isdocumentlevel, validfrom, issummary, requirestaxcertificate, rate, parent_tax_id, c_country_id, c_region_id, to_country_id, to_region_id, c_taxcategory_id, isdefault, istaxexempt, sopotype, issalestax, ad_rule_id)
  VALUES(5000104, @ID_CLIENT@, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PJD', 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PJD)', NULL, 'Y', '2000-01-01 00:00:00.0', 'N', 'N', 5, NULL, NULL, NULL, NULL, NULL, 5000011, 'N', 'N', 'B', 'N', NULL)
;
INSERT INTO C_Tax_Trl (AD_Language,C_Tax_ID, Description,Name,TaxIndicator, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,
UpdatedBy) SELECT l.AD_Language,t.C_Tax_ID, t.Description,t.Name,t.TaxIndicator, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,
t.Updated,t.UpdatedBy FROM AD_Language l, C_Tax t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND 
...
;
INSERT INTO adempiere.c_tax(c_tax_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, name, updatedby, description, taxindicator, isdocumentlevel, validfrom, issummary, requirestaxcertificate, rate, parent_tax_id, c_country_id, c_region_id, to_country_id, to_region_id, c_taxcategory_id, isdefault, istaxexempt, sopotype, issalestax, ad_rule_id)
  VALUES(5000110, @ID_CLIENT@, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PNR', 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PNR)', NULL, 'Y', '2000-01-01 00:00:00.0', 'N', 'N', 3, NULL, NULL, NULL, NULL, NULL, 5000011, 'N', 'N', 'B', 'N', NULL)
;
INSERT INTO C_Tax_Trl (AD_Language,C_Tax_ID, Description,Name,TaxIndicator, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,
UpdatedBy) SELECT l.AD_Language,t.C_Tax_ID, t.Description,t.Name,t.TaxIndicator, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,
t.Updated,t.UpdatedBy FROM AD_Language l, C_Tax t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND 
...
;
INSERT INTO adempiere.c_tax(c_tax_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, name, updatedby, description, taxindicator, isdocumentlevel, validfrom, issummary, requirestaxcertificate, rate, parent_tax_id, c_country_id, c_region_id, to_country_id, to_region_id, c_taxcategory_id, isdefault, istaxexempt, sopotype, issalestax, ad_rule_id)
  VALUES(5000106, @ID_CLIENT@, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PJD', 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PJD)', NULL, 'Y', '2000-01-01 00:00:00.0', 'N', 'N', 5, NULL, NULL, NULL, NULL, NULL, 5000011, 'N', 'N', 'B', 'N', NULL)
;
INSERT INTO C_Tax_Trl (AD_Language,C_Tax_ID, Description,Name,TaxIndicator, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,
UpdatedBy) SELECT l.AD_Language,t.C_Tax_ID, t.Description,t.Name,t.TaxIndicator, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,
t.Updated,t.UpdatedBy FROM AD_Language l, C_Tax t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND 
...
;
INSERT INTO adempiere.c_tax(c_tax_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, name, updatedby, description, taxindicator, isdocumentlevel, validfrom, issummary, requirestaxcertificate, rate, parent_tax_id, c_country_id, c_region_id, to_country_id, to_region_id, c_taxcategory_id, isdefault, istaxexempt, sopotype, issalestax, ad_rule_id)
  VALUES(5000105, @ID_CLIENT@, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PNR', 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PNR)', NULL, 'Y', '2000-01-01 00:00:00.0', 'N', 'N', 3, NULL, NULL, NULL, NULL, NULL, 5000011, 'N', 'N', 'B', 'N', NULL)
;
INSERT INTO C_Tax_Trl (AD_Language,C_Tax_ID, Description,Name,TaxIndicator, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,
UpdatedBy) SELECT l.AD_Language,t.C_Tax_ID, t.Description,t.Name,t.TaxIndicator, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,
t.Updated,t.UpdatedBy FROM AD_Language l, C_Tax t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND 
...
;
INSERT INTO adempiere.c_tax(c_tax_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, name, updatedby, description, taxindicator, isdocumentlevel, validfrom, issummary, requirestaxcertificate, rate, parent_tax_id, c_country_id, c_region_id, to_country_id, to_region_id, c_taxcategory_id, isdefault, istaxexempt, sopotype, issalestax, ad_rule_id)
  VALUES(5000109, @ID_CLIENT@, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PJD', 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PJD)', NULL, 'Y', '2000-01-01 00:00:00.0', 'N', 'N', 5, NULL, NULL, NULL, NULL, NULL, 5000011, 'N', 'N', 'B', 'N', NULL)
;
INSERT INTO C_Tax_Trl (AD_Language,C_Tax_ID, Description,Name,TaxIndicator, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,
UpdatedBy) SELECT l.AD_Language,t.C_Tax_ID, t.Description,t.Name,t.TaxIndicator, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,
t.Updated,t.UpdatedBy FROM AD_Language l, C_Tax t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND 
...
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000102, CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PJD)', 'Y', 'N', 'Y', 'N', 5000016, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000103, CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PNR)', 'Y', 'N', 'Y', 'N', 5000017, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000109, CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PJD)', 'Y', 'N', 'Y', 'N', 5000024, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000105, CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PNR)', 'Y', 'N', 'Y', 'N', 5000019, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000106, CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PJD)', 'Y', 'N', 'Y', 'N', 5000020, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000105, CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PNR)', 'Y', 'N', 'Y', 'N', 5000026, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000101, CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PNR)', 'Y', 'N', 'Y', 'N', 5000013, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
...
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000109, CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PJD)', 'Y', 'N', 'Y', 'N', 5000029, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000110, CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PNR)', 'Y', 'N', 'Y', 'N', 5000030, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000104, CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PJD)', 'Y', 'N', 'Y', 'N', 5000031, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000103, CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PNR)', 'Y', 'N', 'Y', 'N', 5000032, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000102, CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PJD)', 'Y', 'N', 'Y', 'N', 5000033, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000101, CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PNR)', 'Y', 'N', 'Y', 'N', 5000034, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
...
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000104, CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PJD)', 'Y', 'N', 'Y', 'N', 5000018, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
...
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000040, 'L', NULL, 5000110, CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PNR)', 'Y', 'N', 'Y', 'N', 5000023, 5000008, 0, 0, CURRENT_TIMESTAMP, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PNR', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
  VALUES(@ID_CLIENT@, 5000000, 'L', NULL, 5000106,CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PJD)', 'Y', 'N', 'Y', 'N', 5000025, 5000004, 0, 0, CURRENT_TIMESTAMP, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PJD', 0, 0)
;
INSERT INTO adempiere.lco_withholdingcalc(ad_client_id, updatedby, basetype, c_basetax_id, c_tax_id, created, createdby, description, isactive, iscalconinvoice, iscalconpayment, ismodifiableonpayment, lco_withholdingcalc_id, lco_withholdingtype_id, ad_org_id, thresholdmin, updated, name, thresholdmax, amountrefunded)
...
;
INSERT INTO adempiere.lco_withholdingcategory(ad_client_id, ad_org_id, created, createdby, description, updatedby, isdefault, lco_withholdingcategory_id, isactive, updated, name)
  VALUES(@ID_CLIENT@, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago', 100, 'N', 5000004, 'Y', CURRENT_TIMESTAMP, 'Ret ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv')
;
INSERT INTO adempiere.lco_withholdingcategory(ad_client_id, ad_org_id, created, createdby, description, updatedby, isdefault, lco_withholdingcategory_id, isactive, updated, name)
  VALUES(@ID_CLIENT@, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago ', 100, 'N', 5000005, 'Y', CURRENT_TIMESTAMP, 'Ret.ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.')
;
INSERT INTO adempiere.lco_withholdingcategory(ad_client_id, ad_org_id, created, createdby, description, updatedby, isdefault, lco_withholdingcategory_id, isactive, updated, name)
  VALUES(@ID_CLIENT@, 0, CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais', 100, 'N', 5000006, 'Y', CURRENT_TIMESTAMP, 'Ret. ISLR Canones de Arrenda. de Bienes Inmu. en el Pais')
;
INSERT INTO adempiere.lco_withholdingcategory(ad_client_id, ad_org_id, created, createdby, description, updatedby, isdefault, lco_withholdingcategory_id, isactive, updated, name)
...
;
INSERT INTO adempiere.lco_withholdingcategory(ad_client_id, ad_org_id, created, createdby, description, updatedby, isdefault, lco_withholdingcategory_id, isactive, updated, name)
  VALUES(@ID_CLIENT@, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines', 100, 'N', 5000009, 'Y', CURRENT_TIMESTAMP, 'Ret. ISLR Pag. por Serv. de Public. y Propag.  y la cesion')
;
...
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000013, 5000004, 5000011, 5000025, 5000008, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PNR', NULL, NULL, '053')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
...
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000017, 5000005, 5000011, 5000017, 5000008, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PNR', NULL, NULL, '057')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0',CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PJD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000018, 5000005, 5000011, 5000018, 5000008, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PJD', NULL, NULL, '059')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2011-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (JD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000024, 5000009, 5000011, 5000029, 5000008, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PJD', NULL, NULL, '084')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
...
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0',CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PJD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000025, 5000006, 5000011, 5000030, 5000004, 0,CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PJD', NULL, NULL, '063')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PJD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000031, 5000005, 5000011, 5000036, 5000004, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PJD', NULL, NULL, '059')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000019, 5000006, 5000011, 5000020, 5000008, 0, CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PNR', NULL, NULL, '061')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PJD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000020, 5000006, 5000011, 5000019, 5000008, 0, CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PJD', NULL, NULL, '063')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrendamientos de Bines Muebles Situados en el Pais  (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000026, 5000006, 5000011, 5000031, 5000004, 0,CURRENT_TIMESTAMP, 100, 'ISLR Canones de Arrenda. de Bienes Inmu. en el Pais  PNR', NULL, NULL, '061')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
...
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2011-01-07 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000030, 5000009, 5000011, 5000035, 5000004, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PNR', NULL, NULL, '083')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pago de los Administradores de Bines Inmuebles a los Arrendadores de los Bines Inmuebles situados en el pais  (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000032, 5000005, 5000011, 5000037, 5000004, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag Admin. Bienes inmuebles a los Arren bien inmu.  PNR', NULL, NULL, '057')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PJD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000029, 5000009, 5000011, 5000034, 5000004, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PJD', NULL, NULL, '084')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PJD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000033, 5000004, 5000011, 5000038, 5000004, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PJD', NULL, NULL, '055')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', '2011-07-07 10:37:52.0', 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PJD)', 'Y', 'N', NULL, 5000001, NULL, NULL, 5000016, 5000004, 5000011, 5000016, 5000008, 0, '2011-07-08 11:10:53.0', 100, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PJD', NULL, NULL, '055')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2011-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pagos por Servicios de Publicidad y Propaganda y la Cesion de la Venta de Espacios para Tales Fines (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000023, 5000009, 5000011, 5000028, 5000008, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pag. por Serv. de Public. y Propag.  y la cesion  PNR', NULL, NULL, '083')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, NULL, 'N', 'N', NULL, 5000001, NULL, 5000000, 5000000, NULL, 5000001, 5000000, 5000000, 0, CURRENT_TIMESTAMP, 100, 'Retiene 75% de IVA en Ventas', NULL, NULL, NULL)
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
 ...
 ;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
  VALUES(@ID_CLIENT@, '2010-01-01 00:00:00.0', CURRENT_TIMESTAMP, 100, 'ISLR Pagos a Empresas Contratistas o SubContratistas domiciliadas o no en el pais, por la ejecucion de obras o de la prestacion de servicios en base a evaluaciones y ordenes de pago (PNR)', 'Y', 'N', NULL, 5000006, NULL, NULL, 5000034, 5000004, 5000011, 5000039, 5000004, 0, CURRENT_TIMESTAMP, 100, 'ISLR Pago Emp Contra, por Ejecu de Obras o Presta. Serv. PNR', NULL, NULL, '053')
;
INSERT INTO adempiere.lco_withholdingrule(ad_client_id, validfrom, created, createdby, description, isactive, isdefault, lco_bp_isic_id, lco_bp_taxpayertype_id, lco_org_isic_id, lco_org_taxpayertype_id, lco_withholdingcalc_id, lco_withholdingcategory_id, c_taxcategory_id, lco_withholdingrule_id, lco_withholdingtype_id, ad_org_id, updated, updatedby, name, lco_bp_city_id, lco_org_city_id, code)
