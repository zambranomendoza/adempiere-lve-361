...
INSERT INTO adempiere.AD_Element(ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, columnname, entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help)
  VALUES((select max(AD_Element_id)+1 from AD_Element), 0, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 100, 'LVE_invoiceAffected', 'DCS', 'LVE_invoiceAffected', 'LVE_invoiceAffected', 'LVE_invoiceAffected', 'LVE_invoiceAffected', NULL, NULL, NULL, NULL);
