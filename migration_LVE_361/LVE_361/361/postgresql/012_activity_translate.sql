-- 21/09/2012 10:06:25 AM VET
-- Cambio de traduccion de Actividad (ABC) por Centro de Costo
UPDATE AD_Element_Trl SET Name='Centro de Costo',PrintName='Centro de Costo',Help='Los centros de costo indican tareas que son ejecutadas en el curso de un negocio; son usados para el costeo por actividad (ABC)',Updated=TO_TIMESTAMP('2012-09-21 10:06:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1005 AND AD_Language='es_VE'
;

-- 21/09/2012 10:07:05 AM VET
-- Cambio de traduccion de Actividad (ABC) por Centro de Costo
...
-- 21/09/2012 10:08:19 AM VET
-- Cambio de traduccion de Actividad (ABC) por Centro de Costo
UPDATE AD_Menu_Trl SET Name='Centro de Costo',Description='Mantener centros de costo por actividad',Updated=TO_TIMESTAMP('2012-09-21 10:08:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=120 AND AD_Language='es_VE'
;

-- 21/09/2012 10:09:14 AM VET
-- Cambio de traduccion de Actividad (ABC) por Centro de Costo
UPDATE AD_Window_Trl SET Name='Centro de Costo',Description='Mantener centros de costo por actividad',Updated=TO_TIMESTAMP('2012-09-21 10:09:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=134 AND AD_Language='es_VE'
;

-- 21/09/2012 10:09:39 AM VET
-- Cambio de traduccion de Actividad (ABC) por Centro de Costo
UPDATE AD_Tab_Trl SET Name='Centro de Costo',Description='Centro de Costo para Costeo por Actividad',Updated=TO_TIMESTAMP('2012-09-21 10:09:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=249 AND AD_Language='es_VE'
;
