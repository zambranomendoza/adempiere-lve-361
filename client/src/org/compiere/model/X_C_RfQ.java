...
public class X_C_RfQ extends PO implements I_C_RfQ, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20121015L;
...
// S
	...
	/** Set AcctionButton.
		...
		AcctionButton
	  */
	public void setAcctionButton (String AcctionButton)
	{
		set_Value (COLUMNNAME_AcctionButton, AcctionButton);
	}

	/** Get AcctionButton.
		@return AcctionButton
	  */
	public String getAcctionButton () 
	{
		return (String)get_Value(COLUMNNAME_AcctionButton);
	}
