...
public class RequisitionPOCreate extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		if (p_M_Requisition_ID != 0)
		{
			...
			for (int i = 0; i < lines.length; i++)
			{
				...
				{
					process (lines[i], req.getDocumentNo());
				}
			}
			closeOrder();
			return "";
	 ...
	 * 	@throws Exception
	 */
	private void process (MRequisitionLine rLine, String referenceNo) throws Exception
	{
	 ...
	 * 	@throws Exception
	 */
	private void newOrder(MRequisitionLine rLine, int C_BPartner_ID, String referenceNo) throws Exception
	{
		if (m_order != null)
		{
			closeOrder();
		...
		if (m_order == null)
		{
			...
			m_order.setReferenceNo(referenceNo);
	 ...
	 * 	@throws Exception
	 */
	private void newLine(MRequisitionLine rLine, String referenceNo) throws Exception
	{
		if (m_orderLine != null)
		{
			m_orderLine.saveEx();
		...
		{
			newOrder(rLine, C_BPartner_ID, referenceNo);
		}
