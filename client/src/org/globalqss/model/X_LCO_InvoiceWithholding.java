...
// N
	...
	public I_C_BPartner getC_BPartnerTer() throws RuntimeException
    {
		return (I_C_BPartner)MTable.get(getCtx(), I_C_BPartner.Table_Name)
			.getPO(getC_BPartnerTer_ID(), get_TrxName());	}

	/** Set Business Partner  .
		@param C_BPartnerTer_ID 
		Identifies a Business Partner
	  */
	public void setC_BPartnerTer_ID (int C_BPartnerTer_ID)
	{
		if (C_BPartnerTer_ID < 1) 
			set_Value (COLUMNNAME_C_BPartnerTer_ID, null);
		else 
			set_Value (COLUMNNAME_C_BPartnerTer_ID, Integer.valueOf(C_BPartnerTer_ID));
	}

	/** Get Business Partner  .
		@return Identifies a Business Partner
	  */
	public int getC_BPartnerTer_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_BPartnerTer_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set NroReten.
		...
		NroReten
	  */
	public void setNroReten (String NroReten)
	{
		set_ValueNoCheck (COLUMNNAME_NroReten, NroReten);
	}

	/** Get NroReten.
		@return NroReten
	  */
	public String getNroReten () 
	{
		return (String)get_Value(COLUMNNAME_NroReten);
	}
    ...
    {
        return new KeyNamePair(get_ID(), getNroReten());
    }
