...
public class SmjReportLogic {
	 ...
	 * @param nameTrx
	 */
	protected LinkedList<ReportTO> getDataReport(Integer idReport,
			String nameTrx) {
...
//		System.out.println("data SQL::"+sql.toString());
	 ...
	 * @return
	 */
	protected String[] getGeneralTitle(Integer idReportLineSet, String nameTrx) {
		StringBuffer sql = new StringBuffer();
		// cols = 0;
...
//		System.out.println("getGeneralTitle SQL: "+sql.toString());
	 ...
	 * @return String
	 */
	protected String getClientName(String nameTrx) {
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	protected String getOrgName(String nameTrx) {
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	protected String getOrgNIT(String nameTrx) {
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	protected String getPeriodName(Integer idPeriod, String nameTrx) {
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	protected String getCurrency(String nameTrx) {
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	protected String getCodeFont(String nameTrx, Integer codeFont) {
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	protected String getClientCity(String nameTrx) {
		StringBuffer sql = new StringBuffer();
