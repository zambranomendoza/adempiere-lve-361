...
.login-box-body {
	width: 660px;
	background-image: url(../images/login-box-bg_blue.png);
...
.login-box-header {
	background-image: url(../images/login-box-header_blue.png);
	background-color: transparent;
	z-index: 2;
	height: 54px;
	width: 660px;
...
.login-box-footer {
	background-image: url(../images/login-box-footer_blue.png);
